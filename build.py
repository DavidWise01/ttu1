...
@media(max-width:600px){.persona{flex-wrap:wrap;justify-content:center}.pbody{flex:1 1 100%;order:3}}
  ...
  <a href="https://davidwise01.github.io/circuits/" style="display:block;margin-top:12px;padding:15px 18px;border:1px solid var(--plum);background:rgba(154,124,200,.07);text-decoration:none;color:var(--pa);font-family:var(--mono);font-size:12.5px;line-height:1.7;letter-spacing:.02em"><b style="color:var(--plum)">▸ EXHIBIT 6 · THE SUPERPOSITION LABS</b> &nbsp; the smear, made runnable — <b>four LIVE labs</b> (in ENTELÉCHEIA · Circuits) that train the toy model in your browser and show <i>why</i> the interior is the look-into-able black box this universe is about: the <b>GEOMETRY</b> (5→2, the pentagon + WᵀW), the <b>CAPACITY</b> sweep (features-per-dimension vs sparsity), <b>THE HOLOGRAM</b> (3D/4D — superposition as distributed holographic storage), and <b>THE INTERFERENCE FIELD</b> (the features superposed into a literal moiré hologram). A from-scratch reimplementation of Anthropic's Toy Models of Superposition (2022), cited. <span style="color:var(--plum)">run them →</span></a>
